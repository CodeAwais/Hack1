...
# Training function
def train_model(model, criterion, optimizer, train_loader, test_loader, num_epochs=7):
    best_val_auc = 0.0
    train_losses = []
    val_losses = []
    train_accs = []
    ...
    for epoch in range(num_epochs):
        ...
        if val_auc > best_val_auc:
            ...
            torch.save(model.state_dict(), 'best_ms_classifier2.pth')

    model.load_state_dict(torch.load('best_ms_classifier2.pth'))
...
print("Model saved as 'best_ms_classifier2.pth'")
